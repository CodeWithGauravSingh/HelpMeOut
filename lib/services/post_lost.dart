...
class Post_lost extends StatefulWidget {
  const Post_lost({Key? key}) : super(key: key);

  @override
  State<Post_lost> createState() => _Post_lostState();
}

class _Post_lostState extends State<Post_lost> {
  bool button = false;
  String description = '';
  String name = '';
  String number = '';
  ...
  uploadImage() async {
    if (sel_image != null) {
      ...
      FirebaseFirestore.instance.collection('lost').add({
        'name': name,
        'contact': number,
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(
                        hintText: 'Date when item was lost',
                        border: UnderlineInputBorder(),
                      ),
                    ),
                  ],
